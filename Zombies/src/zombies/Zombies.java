...
public class Zombies {
    ...
    public static void main(String[] args) throws InterruptedException {
            ...
            movimiento = entrada.next().charAt(0);
                switch(movimiento){/*Este switch es como un conjunto de "if" pero ahorrando bastante trabajo*/
                    case 'w':
                        ...
                        System.out.println("Si te sales del tablero a tu casa.");
                            ...
                            2=muro.
                            9=jugador*/
                        System.out.println("Te has encontrado con un Zombie!!!!!");
                        vidas--;
                    ...
                    case 'a':/*El resto de switchs funcionan iguales al de arriba, variando si incrementa o decrementa la posición, no hay mas.*/
                        ...
                        System.out.println("Te has encontrado con un Zombie!!!!!");
                        vidas--;/*Te decrementan las vidas*/
                        System.out.println("Te quedan "+vidas+" vidas");
        ...
        System.out.println("Enhorabuena te has muerto, ni tu madre te queria tu vida era una farsa!!!!");
    }
